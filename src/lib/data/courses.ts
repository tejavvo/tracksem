...
export const SEM_DATA: Record<string, Record<string, Course[]>> = {
  ...
  CGD: {
    "Semester 1": [
      ...
      cr("gs0101", "GS0.101", "Spatial Thinking and Practice", 3),
    ],
    "Semester 2": [
      ...
      cr("gs0301", "GS0.301", "Introduction to Spatial Sciences & Technology", 5),
    ],
    "Semester 3": [
    ...
    "Semester 4": [
      ...
      cr("gs3401", "GS3.401", "Geospatial for Sustainable Development", 1),
  ...
  CHD: {
    ...
    "Semester 3": [
      cr("ma6101", "MA6.101", "Probability and Statistics", 0),
      cr("cs1301", "CS1.301", "Algorithm Analysis and Design", 1),
      cr("cs4301", "CS4.301", "Data and Applications", 2),
      cr("cs1302", "CS1.302", "Automata Theory", 3),
      cr("hs0202", "HS0.202", "Thinking and Knowing in the Human Sciences - II", 4),
      cr("hs0216", "HS0.216", "Thinking and Knowing in the Human Sciences - III", 5),
    ],
    "Semester 4": [
      cr("cs2201", "CS2.201", "Computer Systems Organization", 0),
      cr("cs7301", "CS7.301", "Machine, Data and Learning", 1),
      cr("cs6301", "CS6.301", "Design and Analysis of Software Systems", 2),
      cr("hs0302", "HS0.302", "Research Methods in Human Sciences", 3),
      cr("hs7301", "HS7.301", "Science Technology Society", 4),
      cr("hs8305", "HS8.305", "Knowing India Through Data", 5),
    ],
  },
